...
During the early project sprints, the team suffered from assigning ourselves overly ambitious deliverable goals for the sprint time. This was problematic because "rabbit hole" tasks often diverted the team's efforts from executing tasks to meet the minimum viable product agreed prior. To shed some light on the causation of this problem and how we rectified it as a team, we must consider the circumstances that allowed it to occur.
\\
Team ESE1 is a dynamic team, with members from many different backgrounds, with different capabilities and skillsets. To give an example, one member of our team has had particular unique exposure to low level programming and electronic design. During the early customer days, they were likely to push for ambitious goals - perhaps without neglecting the fact that not all members were capable of delivering the work required for these goals. This catalysed by the addition of our enthusiastic customer with a "can-do" attitude. As a result, customer days were often dominated by long conversations about intricate details of technical features not defined to be within the scope of the minimum viable product. Which caused confusion with regards to the customers expectation of the teams performance. This is symptomatic of a young team, which hasn't yet completed many sprints together. For the sake of future sprints, we adopted several measures to help rectify the problem. 
\\ 
Foremost, each team member produced an entry on the GitLab Wiki, highlighting their own skill-set and assets they could bring to development. This filled the role of team experience and allowed us to better evaluate our ability in the early days of development. We also worked to plan for customer days better. The team opted to meet before each customer day to briefly reiterate our own objectives with the customer still absent. This ensured all members were reminded of goals and kept on track during meetings. We also prepared by providing the customer with set options for the future sprint and invoking a discussion regarding the options rather than one which was open-season. These measures all aided us to communicate more clearly with the customer and more inclusively as to what all members regarded as achievable. Additionally, as the team completed more and more sprints, we became better at evaluating ourselves and more skilled at executing customer days.
\\
From this exposure, it gradually became clear that the true purpose of a customer day is for prioritisation of deliverable issues, not to name every possible deliverable feature. Further to this, the team began to consider the project as a whole rather and
